    ...
    return (
        <>
            <div className="mx-auto max-w-3xl">
                ...
                <h1 className="text-3xl font-semibold dark:text-tertiary">Cambiar contraseña</h1>
                <p className="text-xl font-light text-gray-500 mt-5 dark:text-tertiary">Utiliza este formulario para cambiar {""}
