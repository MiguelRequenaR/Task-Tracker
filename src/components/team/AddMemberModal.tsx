                        ...
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                <DialogPanel className="w-full max-w-4xl transform overflow-hidden rounded-2xl bg-white dark:bg-gray-800 dark:border text-left align-middle shadow-xl transition-all p-16">
                                    <DialogTitle
                                        as="h3"
                                        className="font-semibold text-4xl my-5 dark:text-tertiary"
                                    >
                                        Agregar Integrante al equipo
                                    </DialogTitle>
                                    <p className="text-xl font-light text-gray-500 dark:text-tertiary">Busca el miembro por email {''}
                                        <span className="text-secondary font-normal">para agregarlo al proyecto.</span>
                                    </p>
